    ...
    signUp(BuildContext context, String userName, String email,
      ...
      if (signUpformKey.currentState!.validate()) {
        ...
        failureOrUser.fold(
            ...
            (user) {
              UserLocalDataSource(cache: CacheHelper()).cacheUser(key: 'username', userToCache: userName);
              UserLocalDataSource(cache: CacheHelper()).cacheUser(key: 'password', userToCache: password);
              clearControllers();
